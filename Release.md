...
## Improvements
  - (Issue ErrorAnalyzer/ea_dev#176): Absolute difference inspector provided
  - (Issue ErrorAnalyzer/ea_dev#186): Data generated by Absolute Difference Inspector report to YAML database
  - (Issue ErrorAnalyzer/ea_dev#188): Absolute difference inspector now checks range

## Bug fixes
  -

# Version 2.1.0: 16. August 2021

## Improvements
  - Changed to semantic versioning
  - (Issue ErrorAnalyzer/ea_dev#171): Adjusted example/shiftreg to work on Xcelium
  - (Issue ErrorAnalyzer/ea_dev#161): SummaryIncremental - improvement for *ErrorAnalyzer* summary file
  - Updated missing documentation on recently created examples and Analyzer Summary
  - (Issue ErrorAnalyzer/ea_dev#175): Sine wave generator example provided
  - (Issue ErrorAnalyzer/ea_dev#178): Port the sine example to Xcelium
  - Example compatibility matrix in `examples/README.md`
  - (Issue ErrorAnalyzer/ea_dev#153): *ErrorAnalyzer* YAML database, including *EA* regarding information, provided
  
## Bug fixes
  - Fixed an issue in the VPI Interface of the ErrorAnalyzer
